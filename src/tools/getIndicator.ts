...
import { fetchWorldBankIndicator } from "../adapters/worldbank.js";
...
export function resolveIndicator(
  ...
  // World Bank is the default source for any unrecognized code — its indicator
  // space is the broadest, and an unknown code there fails with a clear error.
